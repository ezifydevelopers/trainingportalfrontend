...
const ModuleResources: React.FC<ModuleResourcesProps> = ({
  ...
  const handleUploadResource = async (resourceFile: File, type: string, duration?: number, estimatedReadingTime?: number) => {
    ...
    console.log('Upload resource:', { resourceFile, type, duration, estimatedReadingTime });
            ...
            <div className="flex-1 overflow-auto p-6">
              {selectedResource.type === 'PDF' ? (
                <div className="w-full h-full">
                  <iframe
                    src={selectedResource.url ? `http://localhost:7001${selectedResource.url}` : `${import.meta.env.VITE_API_BASE_URL || 'http://localhost:7001'}/uploads/resources/${selectedResource.filePath}`}
                ...
                <div className="text-center py-12">
                  ...
                  <Button
                    onClick={() => {
                      ...
                      link.href = selectedResource.url ? `http://localhost:7001${selectedResource.url}` : `${import.meta.env.VITE_API_BASE_URL || 'http://localhost:7001'}/uploads/resources/${selectedResource.filePath}`;

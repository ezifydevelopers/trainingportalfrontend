...
export const env = {
  ...
  isProduction,
  isDebugMode,
  apiUrl: import.meta.env.VITE_API_URL || (import.meta.env.DEV ? 'http://localhost:7001/api' : ''),
  baseUrl: import.meta.env.VITE_API_BASE_URL || (import.meta.env.DEV ? 'http://localhost:7001' : ''),

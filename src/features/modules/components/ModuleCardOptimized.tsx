...
interface ModuleCardOptimizedProps {
  module: Module;
  index: number;
...
const ModuleCardOptimized = memo<ModuleCardOptimizedProps>(({
  module,
  index,
  onModuleSelect,
  onEditModule,
...
ModuleCardOptimized.displayName = 'ModuleCardOptimized';

export default ModuleCardOptimized;
